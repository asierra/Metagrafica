...
% axis
polyline(dash="dashed", line_width=0.1) { 0 -7  0 7 }
text("N", align="center", valign="midle") { 0 7.5 }
text("S", align="center", valign="midle") { 0 -7.5 }
arrow_rx = 1.25
arrow_ry = 0.15
% Problema: no hay manera de indicar arcos de elipse
ellipse(arrow_rx, arrow_ry, line_width=2, color="gray", from=180, to=360) { (0.5*arrow_rx) -6.5 }
...
% Problema: el arco de la antena no rota bien
