...
EXAMPLES="curvas3 elevacion_solar espectro fig1 fig2-1 fig2-5 fig4-1 fig4-4 fig6-4 fig_polybar fill_styles fractal_tree franck_condon gravitacion_orbita line_patterns markers-demo orbita_polar path_sample primitives quickstart rpstest sines symbols texto tiro_parabolico turning_points"
